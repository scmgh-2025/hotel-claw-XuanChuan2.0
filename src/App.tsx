...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#eff3fa] via-[#f5f8ff] to-[#e4ebf7] text-slate-800 selection:bg-brand-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="font-display font-black text-slate-900 tracking-tight text-base block">
                  华创云信 · 酒店智能体
                </span>
                <span className="text-[11px] font-bold text-indigo-900 uppercase tracking-widest block -mt-1">
                  产品服务宣传册
                </span>
              </div>
            </div>
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {navItems.map((item) => (
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg text-xs font-bold text-slate-600 hover:text-brand-600 hover:bg-slate-50 transition"
                >
                  {item.name}
                </button>
              ))}
            ...
            <div className="hidden sm:flex items-center gap-3">
              <button
                ...
                className="bg-brand-500 hover:bg-brand-600 text-white text-xs font-bold px-4 py-2 rounded-xl transition duration-300 shadow-lg shadow-brand-500/20 flex items-center gap-1 cursor-pointer"
              >
                <Sparkles className="w-3.5 h-3.5 fill-white" /> 免费试用
              </button>
            </div>
      ...
      {/* 2. Main Hero Banner Section — Dark */}
      <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950/30">
      <section className="relative overflow-hidden pt-6 pb-12 sm:pt-10 sm:pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="inline-flex items-center gap-1.5 bg-blue-400/15 border border-blue-300/25 text-blue-200 text-xs px-3 py-1 rounded-full font-bold shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="font-display text-lg sm:text-xl font-bold text-blue-200">
                全生命周期数智化经营管理引擎
              </p>
            ...
            <div className="grid grid-cols-2 gap-3 max-w-lg">
              <div className="bg-white/10 p-3.5 rounded-2xl border border-white/10">
                ...
                <h3 className="font-display text-sm font-black text-white mt-2">高效减负，释放人力</h3>
                <p className="text-xs text-slate-300 mt-1 font-semibold">AI全天候承接宾客高频咨询，解放前台接待压力。</p>
              </div>
              <div className="bg-white/10 p-3.5 rounded-2xl border border-white/10">
                <span className="text-xl">⚙️</span>
                <h3 className="font-display text-sm font-black text-white mt-2">智能提效，轻松履职</h3>
                <p className="text-xs text-slate-300 mt-1 font-semibold">配备员工专属数字分身，自动派单代办琐事，减少跨部门重复沟通，降低工作压力</p>
              </div>
              <div className="bg-white/10 p-3.5 rounded-2xl border border-white/10">
                <span className="text-xl">💝</span>
                <h3 className="font-display text-sm font-black text-white mt-2">全景可视，穿透管理</h3>
                <p className="text-xs text-slate-300 mt-1 font-semibold">集中汇总客需、工单、人效、营收全维度数据，门店运营一目了然；管理者全局把控，店长实时调度，实现穿透式精细管控</p>
              </div>
              <div className="bg-white/10 p-3.5 rounded-2xl border border-white/10">
                <span className="text-xl">💰</span>
                <h3 className="font-display text-sm font-black text-white mt-2">双线经营，多元创收</h3>
                <p className="text-xs text-slate-300 mt-1 font-semibold">联动店内服务与本地文旅资源，帮助酒店更好地经营自己，经营周边，持续拓宽多元营收</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-3 px-6 rounded-2xl text-xs transition duration-300 shadow-lg shadow-indigo-500/20 cursor-pointer"
              >
                📈 一键测算我的酒店收益
              </button>
            </div>
          ...
          <div className="lg:col-span-7 flex justify-center lg:pl-[20%]">
              ...
              <div className="relative bg-white/5 rounded-3xl border border-white/10 overflow-hidden h-full">
                <img
                ...
                {/* Overlay card */}
                <div className="absolute bottom-6 left-6 right-6 bg-slate-900/95 backdrop-blur-md text-white rounded-2xl p-4 border border-slate-800">
                  <span className="text-[11px] font-bold text-yellow-400 bg-yellow-500/10 px-2 py-0.5 rounded-full border border-yellow-500/20">
                    联名合作-贵州联名品牌代言人
                  </span>
                  <h4 className="text-sm font-bold text-slate-100 mt-1.5">黄小西 IP 酒店智能体</h4>
                  <p className="text-xs text-slate-400 leading-relaxed mt-1">
                    已服务全国 <span className="text-brand-400 font-bold">1000+</span> 酒店。微信扫码，客房呼叫直派工单，打通门票特产，当天上线，立提非房营收！
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-5">
            <div className="bg-brand-500 text-white rounded-xl p-3.5 flex items-start gap-3 shadow-lg shadow-brand-500/20">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">人力成本高</h4>
                <p className="text-[11px] text-white/70 mt-0.5 leading-relaxed">酒店咨询转接、夜班值守等人工工作繁重，员工流动大、培训成本高，人力成本居高不下。</p>
              </div>
            </div>
            <div className="bg-brand-500 text-white rounded-xl p-3.5 flex items-start gap-3 shadow-lg shadow-brand-500/20">
              <div className="w-8 h-8 rounded-lg bg-white/15 flex items-center justify-center shrink-0 text-base">🔍</div>
              <div>
                <h4 className="text-xs font-bold text-white">服务不标准</h4>
                <p className="text-[11px] text-white/70 mt-0.5 leading-relaxed">员工服务能力参差不齐，服务流程、应答口径不统一，易出现服务滞后问题，影响住客体验与门店评分。</p>
              </div>
            </div>
            <div className="bg-brand-500 text-white rounded-xl p-3.5 flex items-start gap-3 shadow-lg shadow-brand-500/20">
              <div className="w-8 h-8 rounded-lg bg-white/15 flex items-center justify-center shrink-0 text-base">📉</div>
              <div>
                <h4 className="text-xs font-bold text-white">酒店管理难</h4>
                <p className="text-[11px] text-white/70 mt-0.5 leading-relaxed">酒店各类运营、数据、人员信息分散，跨部门协同低效，管理层无法实时把控一线运营情况。</p>
              </div>
            </div>
            <div className="bg-brand-500 text-white rounded-xl p-3.5 flex items-start gap-3 shadow-lg shadow-brand-500/20">
              <div className="w-8 h-8 rounded-lg bg-white/15 flex items-center justify-center shrink-0 text-base">🔄</div>
              <div>
                <h4 className="text-xs font-bold text-white">增收缺渠道</h4>
                <p className="text-[11px] text-white/70 mt-0.5 leading-relaxed">酒店营收仅依赖客房，自营产品与本地文旅资源无合规售卖渠道，第三方平台抽成导致收益流失。</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <section id="partner-hotels" className="bg-white border-y border-brand-100/60 py-6 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
              {PARTNER_HOTELS.slice(0, 5).map((hotel, idx) => (
                <div
                  key={idx}
                  className="bg-slate-50 border border-slate-100 rounded-xl overflow-hidden text-center hover:bg-brand-50 hover:border-brand-100 transition"
                >
                  ...
                  <div className="p-3">
                    <div className="text-[11px] font-bold text-slate-800 truncate">{hotel.name}</div>
                    <div className="flex items-center justify-center gap-1.5 mt-1">
                      <span className="text-[11px] bg-brand-100 text-brand-700 px-1.5 py-0.5 rounded font-bold">
                        {hotel.type}
                      </span>
                      <span className="text-[11px] text-slate-400 truncate">{hotel.tag}</span>
                    </div>
                  </div>
                </div>
              ))}
